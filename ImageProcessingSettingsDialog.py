    ...
    def validateDialog(self):
        ...
        if int(self.smoothParam1Edit.text()) % 2 == 0 and int(self.smoothParam1Edit.text()) != 0:
            ...
            QMessageBox.information(self.parentWidget(),
                                    "CATATAN:",
                                    "Smooth parameter 1 harus berupa angka ganjil.\n\n"
                                    "Otomatis set ke (inputted value+1).")
        ...
        if int(self.smoothParam2Edit.text()) % 2 == 0 and int(self.smoothParam2Edit.text()) != 0:
            ...
            QMessageBox.information(self.parentWidget(),
                                    "CATATAN:",
                                    "Smooth parameter 2 harus angka ganjil atau 0.\n\n"
                                    "Otomatis set ke (inputted value+1).")
        ...
        if (self.smoothTypeGroup.checkedButton() == self.smoothGaussianButton
            ...
            QMessageBox.warning(self.parentWidget(),
                                "ERROR:",
                                "Parameters 1 dan 3 tidak bisa 0 saat tipe smoothing GAUSSIAN.\n\n"
                                "Otomatis di set ke default.")
        if (self.smoothTypeGroup.checkedButton() == self.smoothGaussianButton
            ...
            QMessageBox.warning(self.parentWidget(),
                                "ERROR:",
                                "Parameters 2 dan 4 tidak bisa 0 saat tipe smoothing GAUSSIAN.\n\n"
                                "Otomatis di set ke default.")
        ...
        if (self.smoothTypeGroup.checkedButton() != self.smoothGaussianButton
            ...
            QMessageBox.warning(self.parentWidget(),
                                "ERROR:",
                                "Parameters 1 atau 2 tidak bisa 0 untuk smoothing ini.\n\n"
                                "Otomatis di set ke default.")
