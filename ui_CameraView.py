...
class Ui_CameraView(object):
    def setupUi(self, CameraView):
        ...
        self.objek1 = QtWidgets.QLabel(CameraView)
        self.objek1.setText("")
        self.objek1.setObjectName("objek1")
        self.gridLayout.addWidget(self.objek1, 2, 3, 1, 1)
        self.objek2 = QtWidgets.QLabel(CameraView)
        self.objek2.setText("")
        self.objek2.setObjectName("objek2")
        self.gridLayout.addWidget(self.objek2, 3, 3, 1, 1)
        self.objek3 = QtWidgets.QLabel(CameraView)
        self.objek3.setText("")
        self.objek3.setObjectName("objek3")
        self.gridLayout.addWidget(self.objek3, 4, 3, 1, 1)
        self.objek4 = QtWidgets.QLabel(CameraView)
        self.objek4.setText("")
        self.objek4.setObjectName("objek4")
        self.gridLayout.addWidget(self.objek4, 5, 3, 1, 1)
        self.objek5 = QtWidgets.QLabel(CameraView)
        self.objek5.setText("")
        self.objek5.setObjectName("objek5")
        self.gridLayout.addWidget(self.objek5, 6, 3, 1, 1)
    ...
    def retranslateUi(self, CameraView):
        ...
        self.clearImageBufferButton.setText(_translate("CameraView", "Bersihkan Image Buffer"))
        self.label_5.setText(_translate("CameraView", "Resolusi:"))
        self.label_4.setText(_translate("CameraView", "URL perangkat:"))
        self.label_2.setText(_translate("CameraView", "Capture Rate:"))
        self.label_1.setText(_translate("CameraView", "Image Buffer:"))
        self.label_3.setText(_translate("CameraView", "FPS YOLO:"))
        self.label_7.setText(_translate("CameraView", "Kursor:"))
        self.label.setText(_translate("CameraView", "Terdeteksi:"))
